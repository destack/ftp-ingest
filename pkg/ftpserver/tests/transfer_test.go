...
func TestTransfer(t *testing.T) {
	s := NewTestServerWithDriver(&ServerDriver{Debug: true, Settings: &ftpserver.Settings{NonStandardActiveDataPort: true}})
	defer s.Stop()
...
func testTransferOnConnection(t *testing.T, server *ftpserver.FtpServer, active bool) {
	conf := goftp.Config{
		User:            "test",
		Password:        "test",
