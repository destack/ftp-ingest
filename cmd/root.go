...
var RootCmd = &cobra.Command{
	Use:   "ftp-ingest",
	Short: "Run ftp-ingest",
	Long:  `FTP ingest is a server solution to fetch incoming data and port them to modern data holding systems`,
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".ftp-ingest")
	}
